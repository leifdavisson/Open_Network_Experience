        ...
        async function openWifiPortalModal(sensorId) {
            ...
            try {
                const [resSurvey, resPortal] = await Promise.all([
                    fetch(`/api/v1/sensors/${sensorId}/wifi/scan`, { method: 'POST', headers: { 'X-API-Key': ADMIN_KEY } }),
                    fetch(`/api/v1/sensors/${sensorId}/wifi/portal-status`, { headers: { 'X-API-Key': ADMIN_KEY } })
                ]);
        ...
        async function launchCaptiveScreencast(sensorId) {
            ...
            try {
                await fetch(`/api/v1/sensors/${sensorId}/wifi/screencast/start`, {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json', 'X-API-Key': ADMIN_KEY }
                });
        ...
        async function closeCaptiveScreencast(sensorId) {
            ...
            try {
                await fetch(`/api/v1/sensors/${sensorId}/wifi/screencast/stop`, {
                    method: 'POST',
        ...
        async function promptConnectWifi(sensorId, ssid, security) {
            ...
            try {
                ...
                const res = await fetch(`/api/v1/sensors/${sensorId}/wifi/connect`, {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json', 'X-API-Key': ADMIN_KEY },
                    body: JSON.stringify(payload)
                });
